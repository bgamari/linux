...
static struct hdmi_driver_data exynos5410_hdmi_driver_data = {
	.type		= HDMI_TYPE14,
	.phy_confs	= hdmiphy_5410_configs,
	.phy_conf_count	= ARRAY_SIZE(hdmiphy_5410_configs),
	.is_apb_phy	= 1,
};
...
static struct of_device_id hdmi_match_types[] = {
	{
		...
		.data = &exynos5410_hdmi_driver_data,
	}, {
